...
class _WriterScreenState extends State<WriterScreen> {
  ...
  Future<void> _saveDocument() async {
    ...
    try {
      ...
      final updatedDoc = _document!.copyWith(WriterDocumentUpdate(content: currentContent));
  ...
  Future<void> _exportToDocx() async {
    ...
    try {
      ...
      final String currentContent = jsonEncode(_controller!.document.toDelta().toJson());
      final docToExport = _document!.copyWith(WriterDocumentUpdate(content: currentContent));
